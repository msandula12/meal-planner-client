    ...
    <Card raised className={classes.root}>
      ...
      <div className={classes.schedule}>
        ...
        {MOCK_SCHEDULE.map((day) => (
          <ScheduleDay key={dayjs(day.day).format('MM-DD-YYYY')} day={day} />
        ))}
      </div>
      {!currentUser && (
        <div className={classes.notice}>
          ...
          <Typography variant="body2">
            The above schedule is just sample data. Please sign in or create an
            account to start planning your own meals!
          </Typography>
        </div>
      )}
    </Card>
